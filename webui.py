...
with gr.Blocks(title=title).queue() as root:
    github_banner_path = 'https://github.com/uiyo/BGremoval/main/pics/title.png'
    gr.HTML(f'<p align="center"><a href="https://github.com/uiyo/BGremoval"><img src={github_banner_path} width="700"/></a></p>')
    with gr.Row():
